...
author: soroush
comments: true
date: 2013-09-12 08:21:16+00:00
layout: post
...
Samma team som kämpar i månader, eller kanske till och med år, med att få en ”Continuous integration” – miljö att fungera väl, skulle troligtvis lägga ned sina försök med parprogrammering efter bara några veckor. Jag tror det beror på att ”Continuous integration” uppfattas som något  _utmanande och avancerat,__ _något som när det är väl implementerat kan göra att ett utvecklingsteam känner _stolthet _över sin prestation. Parprogrammering däremot uppfattas som något trivialt – det är ju bara att sätta sig ned två och två och börja koda!



Min poäng är inte att parprogrammering är viktigare än någon annan process, inte heller vill jag säga att det passar för alla, bara att synsättet på processen är att det är något som ska ge resultat automagiskt, utan större ansträngning.
...
Ingen kan säga exakt vad som fungerar för ett visst team, utan det handlar om att försöka, utvärdera, och försöka igen.

Efter flitigt parprogrammerande på ett antal företag har jag märkt att vissa hinder och irritationsmoment uppkommit på nästan varje arbetsplats, men de går att övervinnas. Här är min lista på tips för att lyckas med parprogrammering:
  ...
  1. **Tvinga aldrig någon**. Det kanske låter som en självklarhet men det är värt att påpeka. Tror man inte på parprogrammering blir det en självuppfyllande profetia.

	
  2. **Sitt bekvämt**. Justera skrivbordet och stolarna så att båda har möjlighet att ta över tangentbord och mus snabbt. Om de är svårt att åstadkomma det med stora kontorsstolar, byt ut kontorsstolarna till vanliga, smalare stolar. Ett vanligt tecken på att detta misslyckats är att föraren sitter aktiv, framåtlutad, och navigatorn sitter tillbakalutad tillsynes med semestern i tankarna. 

	
  3. **Byt förare ofta.** Helst vid tidsbestämda intervaller, exempelvis var 25:e minut. För det här ändamålet lämpar sig [pomodoro-tekniken ](http://en.wikipedia.org/wiki/Pomodoro_Technique)perfekt. Om någon är obekväm — _jag är inte så bra på det här_ — med en del av uppgiften, är det **extra viktigt** att den personen sitter vid tangentbordet. Att byta förare ofta leder till att båda känner sig aktiva i uppgiften.
